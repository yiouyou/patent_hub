...
def _process_api_result(docname: str, result: dict, user: str | None = None):
	with atomic_transaction():
		...
		field_mapping = {
			...
			"qa_check_0": "qa_check_0",
			"description_revised_1": "description_revised_1",
			"qa_check_1": "qa_check_1",
...
def _get_tech2application_mid_files(doc) -> list[dict]:
	...
	field_to_filename = {
		...
		"qa_check_0": "5.4_qa_check_0.txt",
		"description_revised_1": "5.3_description_revised_1.txt",
		"qa_check_1": "5.4_qa_check_1.txt",
